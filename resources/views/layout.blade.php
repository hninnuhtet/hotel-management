    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="banner" class="collapse @if(request()->is('admin/banner*')) show @endif" href="#" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse @if(request()->is('admin/roomtype*')) show @endif" href="#" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
            ...
            <li class="nav-item">
                ...
                <div id="roomMaster" class="collapse @if(request()->is('admin/room*')) show @endif" href="#" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
            ...
            <li class="nav-item">
                ...
                <div id="customerMaster" class="collapse @if(request()->is('admin/customer*')) show @endif" href="#" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
            ...
            <li class="nav-item">
                ...
                <div id="departmentMaster" class="collapse @if(request()->is('admin/customer*')) show @endif" href="#" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
            ...
            <!-- StaffMaster -->
            <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/department*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#staffMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Staff</span>
                </a>
                <div id="staffMaster" class="collapse @if(request()->is('admin/customer*')) show @endif" href="#" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
