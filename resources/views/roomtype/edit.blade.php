        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Price</th>
                        <td><input type="number" name="price" class="form-control" value="{{$data->price}}"></td>
                    </tr>
                    <tr>
                        <th>Detail</th>
                            ...
                            <table class="table table-bordered mt-2">
                                <tr>
                                    ...
                                    <td class="imgcol{{$img->id}}">
                                        <img width="100" src="{{asset($img->img_src)}}" alt="{{$img->img_alt}}">
                                        <p class="mt-2">
                                            <button type="button" onclick="return confirm('Are you sure you want to delete this image??')" class="btn btn-danger btn-sm delete-image" data-image-id="{{$img->id}}"><i class="fa fa-trash"></i></button></p>
                                    </td>
                                    @endforeach
                                </tr>
                            </table>
