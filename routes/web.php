...
Route::post('save_contactus',[PageController::class,'save_contactus']);
...
Route::get('admin/booking/available_rooms/{_checkindate}', [BookingController::class, 'available_rooms']);
